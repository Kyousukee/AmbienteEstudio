   ...
   if(isset($_POST['btn_listar'])){
     ...
     if ($IDTIP_USU==1){
      if ($buscar!="" AND $buscar!='undefined'){ 
         ...
         $query="SELECT a.*,b.descr_esta FROM noticiasestablecimiento a inner join establecimiento b on a.Id_esta=b.id_esta WHERE (a.tit_ne LIKE '%".$buscar."%' OR a.desc_ne LIKE '%".$buscar."%' OR b.descr_esta LIKE '%".$buscar."%') ORDER BY a.id_ne ASC;";   
     }else{
         $query= "SELECT a.*,b.descr_esta FROM noticiasestablecimiento a inner join establecimiento b on a.Id_esta=b.id_esta ORDER BY a.id_ne ASC; ";
          }
     }else{
      if ($buscar!="" AND $buscar!='undefined'){
         
         $query="SELECT a.*,b.descr_esta FROM noticiasestablecimiento a inner join establecimiento b on a.Id_esta=b.id_esta WHERE (a.tit_ne LIKE '%".$buscar."%' OR a.desc_ne LIKE '%".$buscar."%' OR b.descr_esta LIKE '%".$buscar."%') AND a.Id_esta=".$ID_ESTA." ORDER BY a.id_ne ASC;";  

     }else{
         $query= "SELECT a.*,b.descr_esta FROM noticiasestablecimiento a inner join establecimiento b on a.Id_esta=b.id_esta WHERE a.Id_esta=".$ID_ESTA."  ORDER BY a.id_ne ASC;";
     }
     }
