	angular.module('AngularJSNoticias', [])
	.controller('AngularNoticiasController', ['$scope', '$http', function($scope, $http) {
        ...
        /*INICIO LISTADO DE PROVEEDORES*/
		 ...
		 $http({
		   method: 'POST',
		   url: '../Controlador/SubirNoticia.php',
		   data: form_data,
		...
		self.ProfeFormIng = function() {
        	...
        	$http.post("../Controlador/SubirNoticia.php", fd, {
